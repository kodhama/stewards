...
- S24, R21, and R41–R42: run each declared product extension validator using
  v2's exact argv, working directory, environment/network, request/result,
  exit, repetition, timeout, size, and side-effect protocol. Every declaration
