...
partially supersede only this decision's supported-Codex-surface prerequisite
for catalog admission. Under that proposal, a host-valid package may be listed
...
This annotation is non-operative unless decision 0021 is ratified.
