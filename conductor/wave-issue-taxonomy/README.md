...
| `plugin/migration/legacy-mapping.md` | **undecided — #87.** *"Rides the ratified decision"*, and that decision has left for `kodhama/kodhama`; `specs/0005` §What does not ship kept it here only *"until that lane resolves"*, and Lane A resolved 2026-08-02 | #87. **Deliberately not published**: out of standing agent context — a mapping table plus counts reads as a backlog-sweep plan — and it authorises nothing, since `kodhama-0026` open question 5 leaves migration unauthorised |
