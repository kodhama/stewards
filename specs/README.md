...
| [`kodhama-spec-0003-marketplace-test-observation`](0003-marketplace-test-observation.md) | 1 | gated | Closed product-owned observation of one marketplace revision exercised in GitHub Actions |
| [`kodhama-spec-0004-ci-marketplace-setup-skill`](0004-ci-marketplace-setup-skill.md) | 1 | gated | Host-independent authoring of caller-selected Claude/Codex marketplace setup in GitHub Actions |
