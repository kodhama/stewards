...
| [`kodhama-spec-0002-bounded-pre-agent-provisioner`](0002-bounded-pre-agent-provisioner.md) | 2 | gated | Explicit, idempotent Claude/Codex provisioning before local, CI, or cloud/container agent launch |
