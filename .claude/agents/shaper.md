...
You are the **shaper** agent (grove charter: https://github.com/kodhama/grove/blob/main/charters/shaper.md).
...
- **Record research/evidence as `informed_by`, never `depends_on`.**
  ...
  `.grove/relations.md`, `adr-0011`). Reserve `depends_on` for a source the
