...
4. Self-check against this repo's artifact contract (no dedicated
   spec-quality rubric exists — the contract in the relevant README is
   the bar) and append a `## Rubric check` section with the
